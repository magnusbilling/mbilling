...
$currency = $_SESSION['currency'] == 'U$S' ? 'USD' : $_SESSION['currency'] == 'R$' ? 'BRL' : $_SESSION['currency'] == '€' ? 'EUR' : 'USD';
...
<input type='hidden' name='NombreItem' value="usuario, <?php echo $_SESSION["username"]?>">
<input type='hidden' name='TipoMoneda' value='1'>
<input type='hidden' name='E_Comercio' value='<?php echo $methodPay->username?>'>
<input type='hidden' name='NroItem' value='<?php echo $_SESSION["username"]?>'>
...
<input type='hidden' name='transaction_id' value='<?php echo $_SESSION["id_user"]?>'>
<input type='hidden' name='TRX_ID' value='<?php echo $_SESSION["id_user"]?>' >
</form>
