...
class Queue extends Model
{
	...
	public function rules()
	{
		return array(
			...
			array('language, joinempty, leavewhenempty, name, musiconhold,announce-holdtime,leavewhenempty,strategy, ringinuse, announce-position, announce-holdtime, announce-frequency', 'length', 'max'=>128),
